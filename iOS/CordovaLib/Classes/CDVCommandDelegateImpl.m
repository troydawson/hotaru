...
- (NSString*)pathForResource:(NSString*)resourcepath
{
    ...
    NSString* directoryStr = _viewController.appFolderName;

    if ([directoryPartsJoined length] > 0) {
        directoryStr = [NSString stringWithFormat:@"%@/%@", _viewController.appFolderName, [directoryParts componentsJoinedByString:@"/"]];
    }
